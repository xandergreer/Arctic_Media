...
hiddenimports += ['app.streaming', 'app.scanner', 'app.libraries', 'app.pairing', 'app.main', 'app.auth', 'app.database', 'app.models', 'app.config', 'app.utils', 'app.metadata', 'app.fsbrowse', 'app.admin_users', 'app.tasks_api', 'app.jobs_api', 'app.settings_api', 'app.nav_api', 'app.ui_nav', 'app.tv_api', 'app.streaming_hls', 'app.media_api']
